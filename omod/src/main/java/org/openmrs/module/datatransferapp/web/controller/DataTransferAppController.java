 ...
 */
package org.openmrs.module.datatransferapp.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.DataTransferAppController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class DataTransferAppController {
